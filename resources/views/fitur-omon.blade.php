...
<body>
    <ul class="flex flex-wrap">
        <li>
            <br>
            <a href="/home" class="avatar"><img src="/img/panah.svg" class="ml-8" width="25" height="50"></a>
        </li>
        <h2 class="text-xl font-bold text-black dark:text-[#8897AA] px-3 py-5 ms-5">OMON</h2>
        <li>
            <br>
            <a href="#" class="avatar"><img src="/img/pencarian.svg" class="ml-[1060px]" width="20" height="50"></a>
        </li>
    </ul>
    <div class="bg-[#F2F2F2]">
    <hr class="h-px bg-black border-0 dark:bg-black">
    <br>
        <p class="ml-[50px] text-lg font-sans">Kategori</p>
        <ul class="flex flex-wrap">
            <li>
                <br>
        ...
        <br>
        <p class="ml-[50px] text-xl font-sans">Teratas</p>
        <ul class="flex flex-wrap">
            <li>
                <br>
